...
use Vladanme\Fingerprint\City as FingerprintCity;

class ESCity extends FingerprintElasticsearch
{
    ...
    {
        $fingerprintCity = new FingerprintCity();
        $fingerprintElasticsearchType = new FingerprintElasticsearchType($fingerprintCity);
